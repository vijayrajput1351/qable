...
function profile(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, delay_1.default)(options.durationMillis);
        return stop();
    });
}
...
function start(intervalMicros = DEFAULT_INTERVAL_MICROS, name, sourceMapper, lineNumbers) {
    ...
    (0, time_profiler_bindings_1.setSamplingInterval)(intervalMicros);
    ...
    (0, time_profiler_bindings_1.startProfiling)(runName, lineNumbers);
    return function stop() {
        profiling = false;
        const result = (0, time_profiler_bindings_1.stopProfiling)(runName, lineNumbers);
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        process._stopProfilerIdleNotifier();
        const profile = (0, profile_serializer_1.serializeTimeProfile)(result, intervalMicros, sourceMapper);
        return profile;
    };
}
exports.start = start;
